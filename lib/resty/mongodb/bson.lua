...
local support                = require "resty.mongodb.support"
local iterator               = support.iterator
local assert                 = assert
local error                  = error
...
local new_object_id          = object_id.new
local object_id_mt           = object_id.metatable
...
local function pack( k , v )
    ...
    elseif ot == "nil" or v == ngx_null then
        return "\10" .. k .. "\0"
